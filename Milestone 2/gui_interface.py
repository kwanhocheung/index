...
class search_gui(QWidget):
    def __init__(self, root_dir, searcher) -> None:
        super().__init__()
    ...
    def search(self):
        ...
        tokenized_term = self.searcher.alnum_tokenizer.tokenize(query)
        docname_dict = self.searcher.get_cosine_similarity(tokenized_term)
        ...
        for key, value in docname_dict.items():
            ...
            file_path = self.find_document_in_folder(self.root_dir, folder_name, file_name)
